...
\[
\Nunb_{\text{top,bot}} = - \int_0^1 \left. 
...
the difference between $\langle W \rangle$ and $\langle \Phi \rangle/\Ranb$ must
vanish [e.g., King et al., 2010], so we also compute the percentage error
\[
\delta = \frac{\left| \langle W \rangle- \langle \Phi \rangle/\Ranb  \right|   }
{ \max(\langle W \rangle  , \langle \Phi \rangle /\Ranb  )   } \times 100 \%
\]
\end{itemize}
...
\begin{center}
\includegraphics[width=5.7cm]{exp03/case1/vrms.pdf}
\includegraphics[width=5.7cm]{exp03/case1/Tavrg.pdf}
\includegraphics[width=5.7cm]{exp03/case1/Nu.pdf}\\
...
\includegraphics[width=7cm]{exp03/case1/stats_w.pdf}\\
