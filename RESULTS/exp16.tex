...
\newpage
\begin{center}
\includegraphics[width=5cm]{exp16/plt/solution_divv_0000.png}
\includegraphics[width=5cm]{exp16/plt/solution_e_0000.png}
\includegraphics[width=5cm]{exp16/plt/solution_eta_0000.png}\\
\includegraphics[width=5cm]{exp16/plt/solution_exx_0000.png}
\includegraphics[width=5cm]{exp16/plt/solution_exz_0000.png}
\includegraphics[width=5cm]{exp16/plt/solution_ezz_0000.png}\\
\includegraphics[width=5cm]{exp16/plt/solution_p_0000.png}
\includegraphics[width=5cm]{exp16/plt/solution_rho_0000.png}
\includegraphics[width=5cm]{exp16/plt/solution_u_0000.png}\\
\includegraphics[width=5cm]{exp16/plt/solution_vel_0000.png}
\includegraphics[width=5cm]{exp16/plt/solution_w_0000.png}
\end{center}
