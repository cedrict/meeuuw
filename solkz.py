...
def SolKzSolution(posx, posy):
    ...
    C1 = (
        (
            (0.2e1 * Rp * (0.2e1 * t2 + 0.2e1 * t5 + t7 + B * t8 - 0.3e1 * t1 * B + t13) * AA + t21) * t24
            + (-0.2e1 * t26 * (t4 - t8 - t12 + 0.5e1 * t1) * AA + 0.8e1 * B * BB * km * Rm * Rp) * t38
            - 0.2e1 * B * (0.2e1 * t13 + t12 * Rp - 0.3e1 * t2 + t5 + 0.2e1 * t7 + t8 * Rp) * AA
            - t21
        )
        * t51
        + (
    ...
    C2 = (
        (
            (0.2e1 * t1 * (t2 - t3 - t4 + 0.5e1 * t5) * AA - 0.8e1 * B * BB * t12 * Rp) * t18
            + (
                0.2e1 * Rp * (0.2e1 * t5 * Rp + 0.2e1 * t22 + t2 * B + t25 - 0.3e1 * t26 + B * t4) * AA
                + 0.8e1 * t33 * BB * Rp
            )
            * t38
            + 0.2e1 * t40 * (t41 + t4 + t2 - t3) * AA
            - 0.8e1 * t5 * BB * t12
        )
        * t51
        + (
    ...
    C3 = (
        (
            (-0.2e1 * Rp * (-0.2e1 * t2 - 0.2e1 * t5 + t8 - 0.3e1 * t1 * B + B * t11 + t13) * AA - t21) * t24
            + (0.2e1 * t26 * (t4 - t11 - t7 + 0.5e1 * t1) * AA - 0.8e1 * B * BB * km * Rm * Rp) * t38
            - 0.2e1 * B * (0.2e1 * t8 + 0.2e1 * t13 + 0.3e1 * t2 - t7 * Rp - t5 - t11 * Rp) * AA
            + t21
        )
        * t51
        + (
    ...
    u2 = (
        (-UU * (C1 * t2 + C2 * t4) + C1 * t4 * Rm - C2 * t2 * Rm) * t14
        + (VV * (C3 * t2 + C4 * t4) + C3 * t4 * Rm - C4 * t2 * Rm) * t26
    ...
    t47 = math.exp(-t2)
    u3 = (
        0.2e1 * t4 * (UU * (C1 * t6 + C2 * t8) - C1 * t8 * Rm + C2 * t6 * Rm) * t18
        + 0.2e1 * t4 * (-VV * (C3 * t6 + C4 * t8) - C3 * t8 * Rm + C4 * t6 * Rm) * t31
    ...
    u4 = (
        (
            (C2 * t1 - t3 * C2 + 0.2e1 * UU * C1 * Rm - C2 * t8) * t12
            + C1 * t14 * t1
            - t3 * C1 * t14
            - 0.2e1 * UU * C2 * t20
            - t8 * C1 * t14
        ...
        * t31
        + (
            (-0.2e1 * VV * C3 * Rm + C4 * t1 - C4 * t8 - t38 * C4) * t12
            + 0.2e1 * VV * C4 * t20
            + C3 * t14 * t1
            - t8 * C3 * t14
            - t38 * C3 * t14
    ...
    u5 = (
        ...
        * t108
        - t65
        * (
            -0.4e1 * B * BB * t112 * t113
            + t23 * BB * t119
            + 0.4e1 * t121 * AA * t123
            - 0.4e1 * t121 * BB * t119
            + BB * t118 * t130
            - AA * t112 * t130
            - 0.4e1 * B * AA * t118 * t113
            - t23 * AA * t123
            - 0.4e1 * t24 * AA * t118
            - 0.4e1 * t24 * BB * t112
        )
    ...
    sum7 = sum7 + rho
    SS = (
        math.exp(UU * z) * (C1 * math.cos(Rm * z) + C2 * math.sin(Rm * z))
        + math.exp(-VV * z) * (C3 * math.cos(Rm * z) + C4 * math.sin(Rm * z))
        + math.exp(-2 * z * B) * (AA * math.cos(km * z) + BB * math.sin(km * z))
    )
